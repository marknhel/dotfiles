inoremap ;html <!DOCTYPE html><Enter><html><Enter><head><Enter><title><++></title><Enter><meta charset="UTF-8"><Enter></head><Enter><body><Enter><++><Enter></body><Enter></html><Esc>gg/<++><Enter>"_c4l
...
inoremap ;temp <template><Enter><--><Enter></template><Esc>/<--><Enter>"_4cl
inoremap ;scr <script><Enter><--><Enter></script><Esc>/<--><Enter>"_4cl
