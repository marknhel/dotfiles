...
#readonly labels=( "" "" "" "" "" "" "𝟳" "𝟴" "" )              # Number of lables must match dwl's config.h tagcount
...
pango_tag_active="<span overline='single' overline_color='#eeeeee'>" # Pango span style for 'active' tags
pango_tag_selected="<span                     foreground='#fe8019'>" # Pango span style for 'selected' tags
